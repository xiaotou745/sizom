...
namespace Art.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.Title = "用户注册";
            //if (AccountService.GetUserId() > 0)
            //{
            //    Response.Redirect(SystemService.WebSiteServer + "/", true);
            //}
        ...
        [HttpPost]
        public ActionResult Register(NRegisterModel model)
        {
            ViewBag.Title = "用户注册";
            if (ModelState.IsValid)
            {
                ...
                {
                    return Content(AjaxResult.Error("此邮箱已被注册").ToString());
                }
